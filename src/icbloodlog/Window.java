...
public class Window extends javax.swing.JFrame {
    ...
    private void setRadiusAway(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setRadiusAway
        ...
        */
        ...
        int pintsSum = apos + aneg + bpos + bneg + abpos + abneg + opos + oneg;
        
        float apospcent = apos / pintsSum;
        float anegpcent = aneg / pintsSum;
        float bpospcent = bpos / pintsSum;
        float bnegpcent = bneg / pintsSum;
        float abpospcent = abpos / pintsSum;
        float abnegpcent = abneg / pintsSum;
        float opospcent = opos / pintsSum;
        float onegpcent = oneg / pintsSum;
        
        float totalpcent = apospcent + anegpcent + bpospcent + bnegpcent + abpospcent + abnegpcent + opospcent + onegpcent;
        
        float totalPercentH1 = totalpcent / (check[0].getBlood().get("A+") 
        ...
        float totalPercentH2 = totalpcent / (check[1].getBlood().get("A+") 
        ...
        float totalPercentH3 = totalpcent / ((check[2].getBlood().get("A+")) 
        ...
        rw.hosp1.setText(totalPercentH1 + "% " + "Match to Need");
        rw.hosp2.setText(totalPercentH2 + "% " + "Match to Need");
        rw.hosp3.setText(totalPercentH3 + "% " + "Match to Need");
        rw.setVisible(true);
        /*
        try {
